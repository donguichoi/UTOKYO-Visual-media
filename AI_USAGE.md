...
Generative AI tools were used as assistants in this assignment. All final decisions on experimental design, code execution, and interpretation of results were made by myself.

Tools used
- Perplexity: initial Google Colab environment setup
- Claude:code debugging (majority), diagnostic logging, English language polishing
